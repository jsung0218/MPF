...
int main(int argc, char* argv[]) {
    ROS_INFO("Following Trajectory Planner");
    ros::init (argc, argv, "following_traj_planner");
    ros::NodeHandle nh( "~" );
...
/*
            ...
            has_path = true;
            */
           resultPublisher_obj.reset(new ResultPublisher(nh, initTrajPlanner_obj, mission, param));
           has_path = true;
        }
        if(has_path) {
